...
def load_and_split_documents(folder_path: str, settings: Settings, file_type: str = "pdf"):
    """
...
def main():
    ...
    docs = load_and_split_documents("Documents", settings, file_type="pdf")
...
# 5) Esempi di domande
    ...
    ground_truth = {
        questions[0]: "Un transformer è un'architettura di rete neurale introdotta nel 2017. Si basa sul meccanismo di attenzione che permette di dare al modello più peso alle parti più rilevanti di una sequenza.",
        questions[1]: "Una RNN è un tipo di rete neurale progettata per elaborare sequenze di dati. Ha connessioni cicliche che le permettono di mantenere informazioni sullo stato precedente.",
        questions[2]: "Una CNN è un tipo di rete neurale particolarmente efficace per l'elaborazione di dati con una struttura a griglia, come le immagini. Utilizza convoluzioni per estrarre caratteristiche locali.",
    }
