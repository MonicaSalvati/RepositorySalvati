...
class Settings:
    ...
    # =========================
    lm_base_env: str = os.getenv("OPENAI_BASE_URL")
    """
    ...
    lm_key_env: str = os.getenv("OPENAI_API_KEY")
    """
    ...
    lm_model_env: str = os.getenv("LMSTUDIO_MODEL")
    """
...
def get_embeddings() -> AzureOpenAIEmbeddings:
    ...
    return AzureOpenAIEmbeddings(
        azure_endpoint=settings.lm_base_env,
        api_key=settings.lm_key_env,
...
def main():
    ...
    # 2) Dati -> chunk
    document_loader = DocumentLoader("documents/")
    ...
    # 5) Query ibrida
    questions = [
        "Quali sono i migliori hotel di Dubai?",
        "Quali sono i migliori hotel di Londra?",
        "Quali sono i migliori hotel di DuNew York?",
    ]
